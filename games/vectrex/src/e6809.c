...
static inline unsigned test_c (unsigned i0, unsigned i1,
...
static inline unsigned test_n (unsigned r)
{
	return (r >> 7) & 1;
}
...
static inline unsigned test_z8 (unsigned r)
{
	unsigned flag;
...
static inline unsigned test_z16 (unsigned r)
{
	unsigned flag;
...
static inline unsigned get_reg_d (void)
{
	return (reg_a << 8) | (reg_b & 0xff);
}

static inline void set_reg_d (unsigned value)
{
	reg_a = value >> 8;
	reg_b = value;
}
...
static inline void push8 (unsigned *sp, unsigned data)
{
	(*sp)--;
	write8 (*sp, data);
}
...
static inline void push16 (unsigned *sp, unsigned data)
{
	push8 (sp, data);
	push8 (sp, data >> 8);
}

static inline unsigned pull16 (unsigned *sp)
{
	unsigned datahi, datalo;
...
static inline unsigned sign_extend (unsigned data)
{
